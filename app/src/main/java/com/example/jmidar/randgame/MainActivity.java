package com.example.jmidar.randgame;
...
public class MainActivity extends AppCompatActivity {
    ...
    private  String Pref_Game = "com.example.jmidar.randgame.game";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtHighScore = findViewById(R.id.btn_high_score);
        ...
        txtHighScore.setText("High Score: "+highScore); //value show

        btnPlay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Random random = new Random(); //for generating 0 to 1999
